            ...
            <ul class="list-unstyled components">
                ...
                <li class="">
                    ...
                    <ul class="collapse list-unstyled" id="homeSubmenu">
                        ...
                        <li>
                            <a href="<?php echo base_url().'Mercado/admin'; ?>">Listar</a>
                        </li>
                        <li>
                            <a href="#">Otro</a>
                        </li>
...
<div class="content">
        <br>
        <form method="POST" enctype="multipart/form-data" action="<?php echo base_url();?>Mercado/insertMercado" onSubmit="return Main.ejecutar();">
            <div class="row">
