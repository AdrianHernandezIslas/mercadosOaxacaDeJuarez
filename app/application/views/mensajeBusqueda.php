          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
              <img class="icon-navbar" src="/assets/img/lm.png"  alt="Smiley face">
                <ul class="nav navbar-nav ml-auto">
                  ...
                  <li class="nav-item active">
                    <a class="nav-link separator-option" href="<?php echo base_url(); ?>Mercado/galeria">Galería</a>
                  </li>
                   <li class="nav-item active">
                    <a class="nav-link separator-option" href="<?php echo base_url(); ?>Mercado/descargas">App Móvil</a>
                  </li>
                </ul>
