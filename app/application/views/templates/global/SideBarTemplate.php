            ...
            <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                    <a
                        ...
                        aria-current="true">
                        <i class="fas fa-tachometer-alt fa-fw me-3"></i><span>Inicial</span>
                    </a>
                    <a
                        href="#"
                        class="list-group-item list-group-item-action py-2 ripple active">
                        <i class="fas fa-building fa-fw me-3"></i><span>Mercado</span>
                    </a>
                    <!-- Collapse 1
                    <a
                        class="list-group-item list-group-item-action py-2 ripple"
                    ...
                    <a
                        ...
                        <i class="fas fa-plus fa-fw me-3"></i><span>Mas</span>
                    </a>
                    <!-- Collapsed content -->
