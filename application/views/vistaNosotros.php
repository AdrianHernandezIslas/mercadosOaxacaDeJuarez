...
<div class="container">
    <div class="row">
      ...
      <div class="col-6" align="left">
        <br>
        <img class="img-fluid" src="<?php echo base_url();?>assets/img/logomunicipio.png" height="50" width="100">
      </div>
  ...
  <div class="container">
      ...
      <div class="col-xs-12 col-md-6" style="display:block">
        ...
        <p class="text-justify text-secondary">&nbsp;&nbsp;&nbsp;&nbsp;Además, ofrecemos que todos los turistas y visitantes puedan encontrar el mercado que se ajuste 
      ...
      <div class="col-xs-12 col-md-6">
        <br><br><br>
        <img class="img-fluid" src="<?php echo base_url();?>assets/img/imagen2.jpg" height="350" width="550">
      </div>
    </div>
  </div>
